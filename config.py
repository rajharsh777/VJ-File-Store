...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7907501233 6173076629').split()]
...
DB_URI = environ.get("DB_URI", "mongodb+srv://ff3641240:OYfdWzdneO6bVsAv@cluster0.qslymlh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = environ.get("DB_NAME", "ff3641240")
